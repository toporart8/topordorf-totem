  ...
  return (
    ...
    <div className="min-h-screen text-white font-sans selection:bg-purple-500/30 selection:text-white relative overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0 bg-[#0a0a0a]">
        <div className="absolute top-[-20%] left-[-20%] w-[70%] h-[70%] bg-purple-900/20 rounded-full blur-[120px] animate-pulse"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-blue-900/10 rounded-full blur-[100px]"></div>
      ...
      <div className="max-w-md mx-auto p-6 min-h-screen flex flex-col relative z-20">
        ...
        <header className="text-center mb-10 relative">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-3 uppercase tracking-wider font-serif bg-clip-text text-transparent bg-gradient-to-b from-amber-200 to-amber-700 drop-shadow-sm">
            ТопорДорф
          </h1>
          <p className="text-zinc-500 text-sm uppercase tracking-[0.4em] font-light border-y border-zinc-800/50 py-3 mx-8">
            Творческая мастерская
          </p>
        </header>

        {/* Main Calculator Card */}
        <div className="bg-zinc-900/60 backdrop-blur-xl border border-zinc-700/50 p-1 rounded-2xl shadow-[0_0_40px_-10px_rgba(0,0,0,0.5)] relative overflow-hidden ring-1 ring-white/5">
          ...
          <div className="bg-black/40 rounded-xl p-6 relative overflow-hidden">
            {/* Oracle Badge */}
            <div className="text-center mb-6 px-1">
              <h2 className="text-3xl font-bold text-white uppercase tracking-[0.25em] font-serif drop-shadow-[0_0_15px_rgba(255,255,255,0.3)] w-full mb-6 max-w-full">
                Код Судьбы
              </h2>
              <button
                onClick={() => setIsOracleOpen(true)}
                className="w-full py-4 border border-purple-500/30 bg-purple-900/20 text-purple-300 text-sm font-bold uppercase tracking-widest rounded-xl hover:bg-purple-900/40 hover:text-white transition-all shadow-[0_0_20px_rgba(168,85,247,0.2)] hover:shadow-[0_0_30px_rgba(168,85,247,0.5)] backdrop-blur-sm"
              >
                ✦ Твоя Карта Дня ✦
              </button>
            </div>
            ...
            <div className="p-8 space-y-6">
              ...
              <button
                ...
                className="w-full py-4 bg-gradient-to-r from-amber-600 to-red-600 text-white font-bold uppercase tracking-widest hover:from-amber-500 hover:to-red-500 transition-all duration-300 rounded-xl cursor-pointer relative overflow-hidden group shadow-[0_0_30px_rgba(217,119,6,0.3)] hover:shadow-[0_0_50px_rgba(217,119,6,0.6)] border border-amber-500/30 font-serif"
              >
      ...
      <div className="w-full max-w-2xl mt-12 space-y-8 mx-auto px-6">
        {/* Подписка */}
          ...
          >
            ...
            >
              <div className="p-0 relative">
                ...
                <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-b from-purple-900/20 to-transparent z-0 pointer-events-none"></div>

                <div className="p-6 relative z-10">
                  <div className="flex items-center justify-between mb-8">
                    <button onClick={() => setIsHolidaysOpen(false)} className="text-zinc-500 hover:text-white transition-colors text-xs uppercase font-bold flex items-center gap-2 group">
                      <span className="group-hover:-translate-x-1 transition-transform">←</span> Назад
                    </button>
                    <h2 className="text-xl font-bold text-white uppercase tracking-[0.2em] font-serif text-center drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">
                      Грядущие <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">События</span>
                    </h2>
                    <div className="w-16"></div>
                  </div>

                  <div className="mb-6 flex items-center gap-4">
                    <div className="h-[1px] bg-gradient-to-r from-transparent via-zinc-700 to-transparent flex-grow"></div>
                    <span className="text-zinc-500 text-[10px] uppercase tracking-[0.3em]">Ближайшие 30 дней</span>
                    <div className="h-[1px] bg-gradient-to-r from-transparent via-zinc-700 to-transparent flex-grow"></div>
                  </div>
                  ...
                  <div className="space-y-4">
                    {getUpcomingHolidays().length > 0 ? (
                      getUpcomingHolidays().map((h, idx) => (
                        ...
                        >
                          <div className="absolute -inset-0.5 bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg blur opacity-20 group-hover:opacity-60 transition duration-500"></div>
                          <div className="relative bg-zinc-900 border border-zinc-800 p-5 rounded-lg flex flex-col gap-4 hover:border-zinc-600 transition-colors">
                            <div className="flex items-start gap-4">
                              <div className="w-12 h-12 rounded-full bg-zinc-800 flex items-center justify-center text-2xl border border-zinc-700 shadow-inner group-hover:scale-110 transition-transform duration-300">
                                {h.type === 'male' ? '⚔️' : h.type === 'female' ? '🌺' : '🔮'}
                              </div>
                              <div className="flex-grow">
                                <div className="flex items-center justify-between mb-1">
                                  <span className="text-purple-400 text-xs font-bold tracking-widest uppercase">{h.displayDate}</span>
                                  <span className="w-2 h-2 rounded-full bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.6)] animate-pulse"></span>
                                </div>
                                <h3 className="text-white font-serif text-lg leading-tight group-hover:text-purple-300 transition-colors">{h.name}</h3>
                              </div>
                            </div>

                            <button
                              onClick={() => handleOpenGiftCatalog(h.tags, h.name)}
                              className="w-full py-3 bg-gradient-to-r from-zinc-800 to-zinc-900 border border-zinc-700 hover:border-purple-500 text-zinc-300 hover:text-white font-bold uppercase text-xs rounded transition-all duration-300 flex items-center justify-center gap-2 group/btn relative overflow-hidden"
                            >
                      ...
                      <div className="text-center text-zinc-500 py-12 flex flex-col items-center gap-4">
                        ...
                        <p className="font-serif">В ближайшие 30 дней тишина...</p>
                        <p className="text-xs">Время копить ману.</p>
                      </div>
                    )}
                  </div>
                </div>
        ...
        {isGiftCatalogOpen && (
          ...
          >
            <motion.div
              ...
              exit={{ scale: 0.95, opacity: 0 }}
              onClick={(e) => e.stopPropagation()}
              className="w-full max-w-2xl bg-zinc-900 border border-zinc-700 rounded-xl overflow-hidden shadow-2xl relative mb-10"
            >
              {/* Header */}
              <div className="sticky top-0 bg-zinc-900/95 backdrop-blur z-20 border-b border-zinc-800 p-4 flex items-center justify-between">
                <button
                  onClick={() => { setIsGiftCatalogOpen(false); setIsHolidaysOpen(true); }}
                  className="flex items-center gap-2 text-zinc-500 hover:text-white transition-colors text-xs uppercase tracking-wide font-bold"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" />
                  </svg>
                ...
                <h2 className="text-sm font-bold text-white uppercase tracking-widest font-serif truncate max-w-[150px] text-center">
                  <span className="text-orange-500">{selectedHolidayName}</span>
                </h2>
                ...
                <button
                  ...
                  className="p-2 hover:bg-zinc-800 rounded-full transition-colors"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-zinc-500 hover:text-white">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
                  </svg>
                </button>
              </div>
              ...
              <div className="p-4 space-y-6">
                {giftCatalogProducts.length > 0 ? (
                  giftCatalogProducts.map(p => (
                    <div key={p.id} className="bg-zinc-900 border border-zinc-700 rounded-xl overflow-hidden flex flex-col md:flex-row relative group shadow-lg">
                      {/* Image Section (Left) */}
                      <div className="w-full md:w-1/2 relative shrink-0" style={{ aspectRatio: '3/4' }}>
                        <img src={p.image} alt={p.name} className="w-full h-full object-cover" />
                        <div className="absolute top-0 left-0 p-3">
                          <span className="bg-black/60 backdrop-blur px-2 py-1 text-[10px] uppercase font-bold text-amber-500 rounded border border-amber-500/30">
                            Ручная работа
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="p-5 md:p-6 w-full md:w-1/2 flex flex-col justify-center text-left">
                        <h3 className="text-xl md:text-2xl font-bold text-white uppercase font-serif leading-tight mb-2">
                          {p.name}
                        </h3>
                        ...
                        <button className="text-amber-500 text-xs font-bold uppercase tracking-widest border-b border-amber-500/50 hover:border-amber-500 pb-0.5 self-start mb-4 transition-colors">
                          ✦ Узнать значение символа
                        </button>

                        <div className="mt-auto space-y-3">
                          <div>
                            <p className="text-zinc-500 text-xs line-through mb-1">
                              Цена без скидки: {parseInt(p.price.replace(/\D/g, '')) * 1.2} ₽
                            </p>
                            <p className="text-orange-500 font-bold text-xs uppercase mb-3">
                              Смотреть цену с личной скидкой:
                            </p>
                          </div>

                          <div className="grid grid-cols-2 gap-3">
                            <a href={p.links?.wb || "#"} target="_blank" rel="noreferrer" className="flex items-center justify-center bg-[#8D32C3] hover:bg-[#7828A8] text-white font-bold py-3 rounded-lg text-xs uppercase transition-all shadow-lg hover:shadow-purple-500/20">
                              Wildberries
                            </a>
                            <a href={p.links?.ozon || "#"} target="_blank" rel="noreferrer" className="flex items-center justify-center bg-[#005BFF] hover:bg-[#004ACC] text-white font-bold py-3 rounded-lg text-xs uppercase transition-all shadow-lg hover:shadow-blue-500/20">
                              Ozon
                            </a>
                          </div>

                          <a href="https://t.me/topordorf" target="_blank" rel="noreferrer" className="block text-center w-full py-3 bg-[#229ED9] hover:bg-[#1E8BBF] text-white font-bold rounded-lg text-xs uppercase transition-all shadow-lg hover:shadow-blue-500/20">
                            Получить больше полезной<br />информации бесплатно
                          </a>

                          <div className="grid grid-cols-1 gap-2 pt-2 border-t border-zinc-800">
                            <button className="w-full py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 hover:text-white font-bold rounded-lg text-[10px] uppercase transition-colors">
                              Задать вопрос мастеру
                            </button>
                            <button onClick={() => { setIsGiftCatalogOpen(false); setIsHolidaysOpen(true); }} className="w-full py-2 bg-transparent hover:bg-zinc-800 text-zinc-500 hover:text-white font-bold rounded-lg text-[10px] uppercase transition-colors flex items-center justify-center gap-2">
                              ≡ Весь каталог
                            </button>
                          </div>
                        </div>
                  ...
                  <div className="text-center text-zinc-500 py-12">
                    ...
                    <p>Товары для этого праздника скоро появятся.</p>
                    <button onClick={() => { setIsGiftCatalogOpen(false); setIsHolidaysOpen(true); }} className="mt-4 text-orange-500 hover:text-orange-400 font-bold text-xs uppercase border-b border-orange-500 hover:border-orange-400 pb-0.5">
                      Вернуться назад
                    </button>
                  </div>
                )}
